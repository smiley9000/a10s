...
PRODUCT_COPY_FILES += \
	...
	$(DEVICE_PATH)/biometrics/wosface.hardware.biometrics.face@1.0-service.rc:$(TARGET_COPY_OUT_PRODUCT)/vendor_overlay/$(PRODUCT_EXTRA_VNDK_VERSIONS)/etc/init/wosface.hardware.biometrics.face@1.0-service.rc 
